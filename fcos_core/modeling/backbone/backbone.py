...
from . import resnet_upsampling
from . import resnet_spatial
from . import resnet_CBAM
from . import resnet_SE


#for display
from . import resnet_spatial_display
from . import resnet_SE_display
...
###replace %backbone in "the body = {%backbone}.ResNet(cfg)" by the follow names to activate Attention
###resnet_spatial
###resnet_CBAM
###resnet_SE
    body = resnet_SE.ResNet(cfg)
